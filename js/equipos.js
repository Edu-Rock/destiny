...
const equiposManager={ editingId:null,
  ...
  renderTabla(){
    const equipos=Storage.getEquipos();document.getElementById("team-list-count").textContent=equipos.length;document.getElementById("label-limite-equipos").textContent=`${equipos.length}/${Storage.getTorneo().modalidad||8}`;
